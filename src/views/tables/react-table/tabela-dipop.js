...
// import DIPOP from 'sections/tables/react-table/DIPOPTABLE';
import TablePadrao from 'views/tables/mui-table/tabelaPadrao';
// project import
...
import { DownOutlined, GroupOutlined, RightOutlined, EditTwoTone, StopOutlined, UngroupOutlined } from '@ant-design/icons';
  ...
  const newData = [
    {
      id: 1,
      mapaEstrategico: {
        programaTrabalho: 'DIPOP',
        medidaExecucao: 'Diretoria de Programação de Órteses e Próteses'
      }
    },
    {
      id: 2,
      mapaEstrategico: {
        programaTrabalho: 'DGIE',
        medidaExecucao: 'Diretoria de Gestão de Informações Extrategicas'
      }
    },
    {
      id: 3,
      mapaEstrategico: {
        programaTrabalho: 'DIPLAN',
        medidaExecucao: 'Diretoria de Planegamento e Orçamento'
      }
    }
  ];
    ...
    () => [
      ...
      },
      {
        ...
        columns: [
          ...
          {
            id: 'medidaExecucao',
            header: 'Descrição Unidade Organizacional',
